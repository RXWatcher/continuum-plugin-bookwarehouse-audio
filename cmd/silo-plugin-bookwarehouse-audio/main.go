// Command silo-plugin-bookwarehouse-audio is the BookWarehouse-backed
...
import (
	...
	"github.com/RXWatcher/silo-plugin-bookwarehouse-audio/internal/httproutes"
	"github.com/RXWatcher/silo-plugin-bookwarehouse-audio/internal/localfs"
	"github.com/RXWatcher/silo-plugin-bookwarehouse-audio/internal/migrate"
	pluginrt "github.com/RXWatcher/silo-plugin-bookwarehouse-audio/internal/runtime"
	"github.com/RXWatcher/silo-plugin-bookwarehouse-audio/internal/server"
	"github.com/RXWatcher/silo-plugin-bookwarehouse-audio/internal/store"
...
func main() {
	logger := hclog.New(&hclog.LoggerOptions{Name: "silo-plugin-bookwarehouse-audio"})
