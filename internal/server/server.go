...
<section class="panel"><h2>Stream diagnostics</h2><div class="triage-grid">
<div><h3>Direct file access</h3><p>When enabled, the plugin tries local filesystem streaming before falling back to upstream redirects.</p></div>
<div><h3>Range support</h3><p>Use the Audiobooks portal stream test when clients cannot seek; direct files should return partial content for ranged requests.</p></div>
<div><h3>Path remapping</h3><p>Validate that every BookWarehouse source path maps to a readable container path and does not escape the configured target root.</p></div>
</div></section>
